        ...
        try
        {
            ...
            for (int i = 0; i < computer->Hardware->Count; i++)
            {
                ...
                case HardwareType::Storage:
                {
                    ...
                    InsertValueToMap(m_all_hdd_temperature,nDisk + ClrStringToStdWstring(computer->Hardware[i]->Name), cur_hdd_temperature);
                    ...
                    InsertValueToMap(m_all_hdd_usage,nDisk+ ClrStringToStdWstring(computer->Hardware[i]->Name), cur_hdd_usage);
                ...
                case HardwareType::Motherboard:
                    ...
                    {
                        float fMain;
                        GetHardwareTemperature(computer->Hardware[i], fMain);
                        if (fMain > m_main_board_temperature)
